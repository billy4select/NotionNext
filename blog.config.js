...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Billy4select', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '行銷裡的路人甲', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.billy4select.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '行銷, blog', // 网站关键词 英文逗号隔开
